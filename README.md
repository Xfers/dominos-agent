...
| 11 | 極致干貝海鮮大手拍+香草奶油烤雞小帕瑪滋心+鱈魚星星+青花椒雞塊+香烤薯球+可樂+優惠券+週五七點外送 | 極致干貝海鮮(大/手拍), 香草奶油烤雞(小/帕瑪滋心), 鱈魚星星12塊, 青花椒雞塊, 香烤薯球, 1.25L可樂 | NT$1,134 | PASS — exact order mode ✓, coupon auto-applied ✓, Fri 7PM delivery ✓ |
...
| 11 | 2 | - | exact (seafood+chicken) | ×1 | ×3 | Fri 7PM | delivery | ✓ |
...
- **Exact order mode** — specify exact pizza names, sizes, crusts, and side items; agent matches precisely instead of randomizing
- **Auto coupon application** — applies best available BOGO voucher (買大送大/買大送小) from pizza menu page; adapts to live promotions
